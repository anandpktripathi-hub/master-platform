# SmetaSC SaaS Multi-Tenancy App — Verified 360° Repository Report
...
- A deterministic scan output: `docs/_repo_scan_summary.json`
- Successful local builds (backend + frontend)

Where you see a percentage, it is an **evidence-based completeness estimate** (presence of controllers/services/DTOs/tests/docs), **not a business guarantee** that every user-flow is finished.
...
2) **Docs drift:** documentation claims some versions/ports that do not match current package manifests (example: docs say React 18 + Router v6, but frontend uses React 19 + Router v7).
3) **Config duplication:** duplicate formatter/linter configs exist (root + frontend).
4) **Known dead/empty files:** frontend route-map outputs are 0 bytes; a .bak config exists.
5) **Backend DB split risk:** Mongoose + TypeORM coexist; TypeORM datasource is Postgres-configured while compose config uses MongoDB for DATABASE_URI.
...
**Overall weighted score:** 95%  |  **Critical-path minimum:** 80%

| Stage | Score | Checks Passed | Notes |
|---|---:|---:|---|
| subscriptions | 100% | 6/6 | Plans/packages/subscriptions lifecycle and UI entry points |
| payments | 86% | 6/7 | Ability to take payment (Stripe/PayPal) from UI through backend processing |
...
| invoicing | 80% | 4/5 | Invoice model + API + UI to view/export invoices |
| adminControls | 100% | 6/6 | Admin RBAC, user/role management, settings, audit logs |
| marketplaceReady | 100% | 7/7 | CodeCanyon-style packaging: installability, docs, docker, deploy guides, CI presence |

### Hard Blockers / Missing Evidence (Auto-detected)
- [payments] PayPal API endpoint exists (controller route)
- [invoicing] Invoice PDF/export implementation exists (not just dependency)
...
- **marketplaceReady**: `C:/Users/annes/Desktop/smetasc-saas-multi-tenancy-app/docs/QUICK_START.md`, `C:/Users/annes/Desktop/smetasc-saas-multi-tenancy-app/docs/DEPLOYMENT_GUIDE.md`, `C:/Users/annes/Desktop/smetasc-saas-multi-tenancy-app/docs/ENVIRONMENT_VARIABLES.md`, `C:/Users/annes/Desktop/smetasc-saas-multi-tenancy-app/docker-compose.yml`, `C:/Users/annes/Desktop/smetasc-saas-multi-tenancy-app/START-BOTH.bat`, `C:/Users/annes/Desktop/smetasc-saas-multi-tenancy-app/START-BACKEND.bat`
...
**Scoring rubric (backend):** controllers/services/modules/DTOs/models/tests/docs/migrations are treated as evidence of completeness. A high score means “more implementation artifacts exist”, not “all business rules are correct.”

| Module | Evidence % | Launch-Readiness % | Earning Stages | Files | Missing Artifacts | Subfolders |
|---|---:|---:|---|---:|---|---|
| settings | 73 | 63 | adminControls | 49 | Tests, Docs, Migrations | dto, mappers, schemas |
| domains | 70 | 63 | — | 9 | Schema/Entity, Docs, Migrations | dto, services |
| auth | 67 | 63 | — | 14 | Tests, Docs, Migrations | dto, schemas, services, strategies |
| themes | 65 | 63 | — | 7 | Tests, Docs, Migrations | controllers, dto, schemas, services |
| payments | 60 | 50 | payments | 7 | DTO, Schema/Entity, Docs, Migrations | controllers, services |
| billing | 60 | 50 | payments | 6 | DTO, Schema/Entity, Docs, Migrations | — |
| notifications | 60 | 50 | — | 6 | DTO, Schema/Entity, Docs, Migrations | — |
| crm | 60 | 50 | — | 5 | DTO, Schema/Entity, Docs, Migrations | — |
| hierarchy | 57 | 50 | — | 14 | DTO, Tests, Docs, Migrations | — |
| users | 55 | 50 | — | 8 | Schema/Entity, Tests, Docs, Migrations | dto |
| custom-domains | 55 | 50 | — | 6 | Schema/Entity, Tests, Docs, Migrations | dto, services |
| coupons | 55 | 50 | — | 5 | Schema/Entity, Tests, Docs, Migrations | dto, services |
| rbac | 55 | 50 | adminControls | 5 | Schema/Entity, Tests, Docs, Migrations | dto |
| tenants | 55 | 50 | — | 5 | Schema/Entity, Tests, Docs, Migrations | dto |
| profile | 55 | 50 | — | 4 | Schema/Entity, Tests, Docs, Migrations | dto |
| packages | 45 | 38 | subscriptions | 4 | DTO, Schema/Entity, Tests, Docs, Migrations | services |
| products | 45 | 38 | — | 4 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| accounting | 45 | 38 | invoicing | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| ai-services | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| analytics | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| chat | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| dashboard | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| developer-portal | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| hrm | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| logs | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| marketplace | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| onboarding | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| pos | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| projects | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| reports | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| social | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| support | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| theme | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| user | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| vcards | 45 | 38 | — | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| cms | 30 | 25 | — | 2 | Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| health | 30 | 25 | — | 2 | Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| orders | 30 | 25 | — | 2 | Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| seo | 30 | 25 | — | 2 | Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| tenant | 30 | 25 | — | 2 | Module, DTO, Schema/Entity, Tests, Docs, Migrations | — |
...
|---|---:|---:|---:|---|---|
| cms | 71 | 63 | 39 | Tests, Docs, Migrations | controllers, database, dto, entities, enums, schemas, services, types |
| tenants | 69 | 63 | 25 | Tests, Docs, Migrations | branding, dashboard, database, domain, entities, ssl |
| common | 61 | 50 | 37 | Controller, DTO, Docs, Migrations | calendar, decorators, domain-reseller, enums, guards, integrations, interfaces, middleware, push-notification, schemas, storage, utils, webhooks |
| billing | 59 | 50 | 28 | DTO, Tests, Docs, Migrations | affiliate, analytics, stripe, usage, wallet |
| feature-registry | 45 | 38 | 8 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| workspaces | 45 | 38 | 4 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| health | 45 | 38 | 3 | DTO, Schema/Entity, Tests, Docs, Migrations | — |
| database | 35 | 25 | 59 | Controller, Service, DTO, Tests, Docs, Migrations | schemas |
| auth | 30 | 25 | 6 | Module, DTO, Schema/Entity, Tests, Docs, Migrations | guards, interfaces, strategies, unified-registration |
| metrics | 30 | 25 | 2 | Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| logger | 15 | 13 | 1 | Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| services | 15 | 13 | 1 | Module, Controller, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| middleware | 0 | 0 | 5 | Module, Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| config | 0 | 0 | 5 | Module, Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| guards | 0 | 0 | 4 | Module, Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| audit | 0 | 0 | 1 | Module, Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | interfaces |
| filters | 0 | 0 | 1 | Module, Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| pipes | 0 | 0 | 1 | Module, Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| utils | 0 | 0 | 1 | Module, Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| types | 0 | 0 | 1 | Module, Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
| strategies | 0 | 0 | 0 | Module, Controller, Service, DTO, Schema/Entity, Tests, Docs, Migrations | — |
...
| Area | Evidence % | Launch-Readiness % | Files | Missing Artifacts | Subfolders |
|---|---:|---:|---:|---|---|
| pages | 67 | 50 | 86 | API, Tests, Docs | admin, app, cms, dashboard, developer, domains, marketplace, packages, services, tenant |
| router.tsx | 50 | 0 | 1 | Routes, Components, API, Tests, Styles, Docs | — |
| modules | 30 | 33 | 12 | Routes, API, Tests, Docs | accounting, hierarchy, hrm |
| admin | 30 | 33 | 11 | Routes, API, Tests, Docs | — |
| theme | 30 | 33 | 6 | Routes, API, Tests, Docs | — |
| components | 26 | 17 | 50 | Routes, API, Tests, Styles, Docs | analytics, billing, common, DashboardWidgets, guards, logs, PageBuilder |
| contexts | 20 | 17 | 5 | Routes, API, Tests, Styles, Docs | — |
| providers | 20 | 17 | 1 | Routes, API, Tests, Styles, Docs | — |
| themes | 20 | 17 | 1 | Routes, API, Tests, Styles, Docs | — |
| api | 15 | 17 | 10 | Routes, Components, Tests, Styles, Docs | — |
| styles | 10 | 17 | 5 | Routes, Components, API, Tests, Docs | — |
| services | 0 | 0 | 10 | Routes, Components, API, Tests, Styles, Docs | — |
| types | 0 | 0 | 4 | Routes, Components, API, Tests, Styles, Docs | — |
| utils | 0 | 0 | 2 | Routes, Components, API, Tests, Styles, Docs | — |
| navigation | 0 | 0 | 1 | Routes, Components, API, Tests, Styles, Docs | — |
...
### Environment VariablesSee `docs/ENVIRONMENT_VARIABLES.md` for the full reference. The backend also contains runtime checks for a subset of critical env vars.
...
- Add a short module README: purpose, endpoints, env vars, gotchas.
...
- Relevant stage scores: **payments: 86%**
- Files scanned: **7**
...
- Relevant stage scores: **invoicing: 80%**
- Files scanned: **3**
...
- Launch-readiness (structural): **25%**
- Earning stages (inferred): **—**
- Files scanned: **2**
...
- Document how to run/validate this area locally.

### frontend/src/router.tsx
- Evidence completion: **50%**
- Launch-readiness (structural): **0%**
- Files scanned: **1**
